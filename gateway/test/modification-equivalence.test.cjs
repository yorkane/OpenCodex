...
test("all 108 modification points preserve synchronous call contracts through the production Kernel", () => {
  const calls = new Map();
...
test("all 108 modification points preserve Promise identity and thrown errors in production Kernel", async () => {
